...
public class ArchivoAdjuntoHelper {
    ...
    public static void abrir(Context context, File archivo, String mimeType) {
        try {
            ...
            Toast.makeText(context, "No se pudo abrir el archivo: " + e.getMessage(), Toast.LENGTH_SHORT).show();
        }
    }
}
